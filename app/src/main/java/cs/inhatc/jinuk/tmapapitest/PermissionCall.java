...
public class PermissionCall extends AppCompatActivity {
    ...
    public PermissionCall(Context context){
        ...
        int permissionCheckCL = ContextCompat.checkSelfPermission(context,
                Manifest.permission.ACCESS_COARSE_LOCATION);

        // Here, thisActivity is the current activity
        if (permissionCheckFL != PackageManager.PERMISSION_GRANTED) {
        ...
        if (permissionCheckCL != PackageManager.PERMISSION_GRANTED) {
